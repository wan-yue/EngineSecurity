function HdBusinessAuditFace(configs) {
	/** 全局属性区 */
	...
	this.businuessDataSqlId = "";//业务数据url
	...
	this.Constructor = function() {// 构造方法
		...
		if (me.businuessDataSqlId != "") {// 列表默认值
			me.tableAction = "common.action?command=workflow.hdBusinessData&BUS_SQLID=" + me.businuessDataSqlId;
		}else{
			me.tableAction = "common.action?command=workflow.hdBusinessData&BUS_TABLENAME=" + me.en;
		}
